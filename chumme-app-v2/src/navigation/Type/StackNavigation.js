...
export default function StackNavigation() {
  ...
  function AuthNavigation() {
    return (
      <Stack.Navigator
        ...
        initialRouteName={StackNav.LoginSuccess}>
        ...
        />
        <Stack.Screen
          name={StackNav.VerifyPhone}
          component={StackRoute.VerifyPhone}
        />
        <Stack.Screen
          name={StackNav.LoginSuccess}
          component={StackRoute.LoginSuccess}
        />
      </Stack.Navigator>
    );
  }
  ...
  return (
    <Stack.Navigator
      ...
      <Stack.Screen name={StackNav.AiChat} component={StackRoute.AiChat} />
    </Stack.Navigator>
  );
}
